...
import { mergeFacts } from "../model.js";
import { buildComposeMessages } from "../prompts/compose.js";
import { buildDraft, callLlmJson, loadDraft, sanitizeText, saveDraft, } from "./shared.js";
/**
 * 阶段三：成稿。
 *
 * 与 refine 的区别在于「约束强度」：
 ...
 * 产出的是一份可以直接投递的定稿。
 */
export function createComposeCapability(host) {
    return {
        id: "compose",
        async run(input, ctx) {
